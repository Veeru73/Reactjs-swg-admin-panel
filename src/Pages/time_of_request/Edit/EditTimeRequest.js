...
import { EditDepartmentForm, EditTimeRequestForm, EditVendorForm } from './EditTimeRequestForm'
import { useLocation } from 'react-router-dom'
import { Loader } from '../../../components/Loader'
import { ReactComponent as AddIconSvg } from '../../../images/Arrow-Left.svg';

export const EditTimeRequest = () => {
                    ...
                    <Row>
                        ...
                        <Col md={9}>
                            ...
                            <div className='my-md-4'>
                                ...
                                <EditTimeRequestForm pre={preData} setLoading={setLoading} />
                            </div>
                        </Col>
                    </Row>
                </Container>
